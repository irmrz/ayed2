...
int main(int argc, char *argv[]) {
    ...
    int maximos[YEARS];
    int max_precip[YEARS];
    int temperatura_minima_total;

    temperatura_minima_total = minima_historica(array);
    mayor_temp_max(array,maximos);
    max_mensual_precip(array,max_precip);

    printf("La temperatura minima es: %d\n",temperatura_minima_total);
    
    printf("\nMaximas temperaturas por año: \n");
    dump_year_temp_array(maximos);

    printf("\nMeses de maxima precipitación por año: \n");
    dump_year_month_array(max_precip);
