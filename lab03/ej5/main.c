...
// cpu time used to sort the array: 0.000890 seconds.

/*
Si no estuviese la función destroy pareciese no pasar nada, ya que en la terminal 
no se nos muestra ningún error. Pero si no ponemos el destroy,  los punteros quedarían
apuntando a ese espacio de memoria, o sea no liberan espacio y tenemos un pedazo
de memoria que está siendo usada para nada.

Tardó menos tiempo, en el ejercicio 2 tardó: 0.002305 seconds
*/