...
int main(void) {
    ...
    */
    ...
    //Declaro temp y people que es donde voy a guardar los valores de 
    int *temp = NULL;
    person_t *people = NULL;

    // 'temp' primero busca la direccion de x(&x) y después le asigno el valor 
    temp = &x;
    *temp = 9;
